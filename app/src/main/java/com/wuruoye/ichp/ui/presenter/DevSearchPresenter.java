...
import static com.wuruoye.ichp.ui.SearchActivity.TYPE_COURSE;
import static com.wuruoye.ichp.ui.SearchActivity.TYPE_ENTRY;
import static com.wuruoye.ichp.ui.SearchActivity.TYPE_NOTE;
import static com.wuruoye.ichp.ui.SearchActivity.TYPE_USER;
...
public class DevSearchPresenter extends SearchContract.Presenter {

    @Override
    public void requestSearchResult(String query, int type, boolean isAdd) {
        ...
        if (type == TYPE_NOTE) {
            ...
            List<Entry> data = Arrays.asList(
                    ...
                    new Entry("秸秆扎刻", "https://gss0.bdstatic.com/-4o3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike80%2C5%2C5%2C80%2C26/sign=f900350f2a34349b600b66d7a8837eab/7e3e6709c93d70cfe7ea7e18fadcd100baa12b97.jpg")
            );
            for (int i = 0; i < 5; i++) {
                dataList.addAll(data);
            }
        ...
        if (isAvailable()) {
            getView().onSearchResult(dataList, isAdd);
        }
    }
}
